...
/*------------------------------------------------------Macros-------------------------------------------------------*/
/*********************************************************************************************************************/
#define CHANNELS_NUM    8                       /* Number of used channels                                          */
#define VAR_RES_CHANNEL 7
...
IfxVadc_ChannelId g_vadcChannelIDs[] = {IfxVadc_ChannelId_0,  /* AN36: channel 4 of group 4                         */
                                        IfxVadc_ChannelId_1,  /* AN37: channel 5 of group 4                         */
                                        IfxVadc_ChannelId_2,  /* AN38: channel 6 of group 4                         */
                                        IfxVadc_ChannelId_3,
                                        IfxVadc_ChannelId_4,
                                        IfxVadc_ChannelId_5,
                                        IfxVadc_ChannelId_6,
...
//    }
    ...
    /* Set the channel ID and the corresponding result register */
    adcChannelConf[chn].channelId = g_vadcChannelIDs[chn]; /* The channels 7 are initialized        */
    adcChannelConf[chn].resultRegister = (IfxVadc_ChannelResult) (chn);
    adcChannelConf[chn].backgroundChannel = TRUE; /* Enable background scan for the channel   */
